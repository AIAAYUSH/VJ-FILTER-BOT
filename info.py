...
API_ID = int(environ.get('API_ID', '26736246'))
API_HASH = environ.get('API_HASH', 'ae230ba5638f8de4dc459711f0c7ebc1')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/WlC.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1145706763').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002238727196'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002222588099').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002164103422') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://streamjunction:streamjunction@cluster0.wj2fn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://ayush2023021057:m8T27yNgGehE52Te@cluster0.4dsc559.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://streamjunction:streamjunction@cluster0.wj2fn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://aayushsingh28383:vi2KEyP8joYD8cPi@cluster0.iaqmvto.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/Wlh.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/StreamJunction')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+C3v-dw_6yH45YmQ1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'streamjunctionsupport') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/BRINGHIGH')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '05f8f6d14e60f99c6f1d68dfc4a192c809019ed3')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/+C3v-dw_6yH45YmQ1')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '05f8f6d14e60f99c6f1d68dfc4a192c809019ed3')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+C3v-dw_6yH45YmQ1') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
REACTIONS = ["ðŸ¤", "ðŸ˜‡", "ðŸ¤—", "ðŸ˜", "ðŸ‘", "ðŸŽ…", "ðŸ˜", "ðŸ¥°", "ðŸ¤©", "ðŸ˜±", "ðŸ¤£", "ðŸ˜˜", "ðŸ‘", "ðŸ˜›", "ðŸ˜ˆ", "ðŸŽ‰", "âš¡ï¸", "ðŸ«¡", "ðŸ¤“", "ðŸ˜Ž", "ðŸ†", "ðŸ”¥", "ðŸ¤­", "ðŸŒš", "ðŸ†’", "ðŸ‘»", "ðŸ˜"] #don't add any emoji because tg not support all emoji reactions
